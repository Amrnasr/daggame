...
public class GetClosestOwnedTile extends LeafTask {

	public GetClosestOwnedTile(Blackboard blackboard) 
	{
		super(blackboard);
	}

	public GetClosestOwnedTile(Blackboard blackboard, String name) 
	{
